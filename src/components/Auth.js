...
const Auth = () => {
  ...
  const submitHandler = (e) => {
    ...
    if (isLogin) {
      url =
        "https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyAraxx_46RjDk7l5-KmSwqahc0Pq4U2vLA";
    } else {
      ...
      url =
        "https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyAraxx_46RjDk7l5-KmSwqahc0Pq4U2vLA";
    }

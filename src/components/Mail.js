...
const Mail = () => {
  ...
  const submitHandler = (e) => {
    ...
    sendRequest(
      {
        url: "https://mail-box-ebf7e-default-rtdb.firebaseio.com/emails.json",
        method: "POST",
        body: mailData,
      },
    ...
    <Container className="border border-dark mb-5">
      <Form className="p-3 mb-3" onSubmit={submitHandler}>
        ...
        <Editor
          ...
          toolbarClassName="border border-dark p-1 bg-light"
          wrapperClassName=""
          editorClassName="border border-dark p-3 min-vh-100"
